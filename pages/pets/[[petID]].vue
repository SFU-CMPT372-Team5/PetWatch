...
export default {
  ...
  async setup() {
    ...
    //Wait for pet data to arrive, and run code relevant to lost pets only
    //If we are working with the edge case above, this code will never trigger, which is good!
    watch(petData, (newVal) => {
      if (newVal == undefined) return;
      const petRes = petData.value!;
